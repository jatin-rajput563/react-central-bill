                ...
                <div className="max-w-[1140px] mx-auto px-3">
                    <div className="flex flex-row flex-wrap -mx-3 ">
                        ...
                        <div className="w-full min-lg:w-6/12 max-lg:mt-[40px]">
                            ...
                            <p className='font-normal family text-[24px] leading-[110%] text-[#003459] m-0 pt-[38px] max-lg:text-center mx-auto max-lg:pt-[20px] max-lg:!text-[20px] '>Benefits of Comparing Energy Plans</p>
                            <div className='max-lg:justify-center max-lg:flex max-lg:items-center'>
                                <ul className='list-disc pt-[28px] max-lg:pt-[16px] pl-[22px] max-lg:pl-[46px]'>
                                    <li>
